...
export default function FinancialReport() {
  ...
  const report = useMemo(() => {
    ...
    const monthBonuses = bonuses.filter((b) => String(b.date || "").startsWith(selectedMonth));
    ...
    const monthAdvances = advances.filter((a) => String(a.date || "").startsWith(selectedMonth) && a.status === "approved");
    ...
    const monthProduction = dailyProd.filter((d) => String(d.date || "").startsWith(selectedMonth));
